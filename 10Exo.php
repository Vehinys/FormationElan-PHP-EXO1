...
while ($reste >= 10) {
    $compteurBilletDix++;                      // Calcul du nombre de billets de 10 €
    $reste -= 10;                              // Mise à jour du reste
}

if  ($reste >= 5) {
    $compteurBilletCinq ++;                    // Calcul du nombre de billets de 5 €
    $reste -= 5;                               // Mise à jour du reste
}

while ($reste >= 2) {
    $compteurPieceDeux ++;                     // Calcul du nombre de pièces de 2 €
    $reste -= 2;                               // Mise à jour du reste
}

if ($reste >= 1) {
    $compteurPieceUn ++;                       // Calcul du nombre de pièces de 2 € 
